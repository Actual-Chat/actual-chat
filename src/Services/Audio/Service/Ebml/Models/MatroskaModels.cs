...
//--------------------------------------------------------------------------------------------------------
// <auto-generated>
//     This C# code class was auto-generated at 08/16/2021 20:31:00.
...
namespace ActualChat.Audio.Ebml.Models
{
    ...
    public static class ModelExtensions
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this BaseModel model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.EBML:
                    ((EBML)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.DocTypeExtension:
                    ((DocTypeExtension)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.AttachedFile:
                    ((AttachedFile)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.EditionEntry:
                    ((EditionEntry)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Cluster:
                    ((Cluster)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.BlockGroup:
                    ((BlockGroup)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.BlockMore:
                    ((BlockMore)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ReferenceFrame:
                    ((ReferenceFrame)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.TimeSlice:
                    ((TimeSlice)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.SilentTracks:
                    ((SilentTracks)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.CuePoint:
                    ((CuePoint)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.CueTrackPositions:
                    ((CueTrackPositions)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.CueReference:
                    ((CueReference)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Info:
                    ((Info)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ChapterTranslate:
                    ((ChapterTranslate)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Seek:
                    ((Seek)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Targets:
                    ((Targets)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.TrackEntry:
                    ((TrackEntry)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Audio:
                    ((Audio)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.BlockAdditionMapping:
                    ((BlockAdditionMapping)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ContentEncoding:
                    ((ContentEncodingItem)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ContentCompression:
                    ((ContentCompression)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ContentEncryption:
                    ((ContentEncryption)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.ContentEncAESSettings:
                    ((ContentEncAESSettings)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.TrackPlane:
                    ((TrackPlane)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.TrackJoinBlocks:
                    ((TrackJoinBlocks)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.TrackTranslate:
                    ((TrackTranslate)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Video:
                    ((Video)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Colour:
                    ((Colour)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.MasteringMetadata:
                    ((MasteringMetadata)model).FillScalar(descriptor, size, reader);
                    break;
                case MatroskaSpecification.Projection:
                    ((Projection)model).FillScalar(descriptor, size, reader);
                    break;
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillComplex(this BaseModel model, ElementDescriptor descriptor, BaseModel propertyModel)
        {
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.EBML:
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillListEntry(this BaseModel model, ElementDescriptor descriptor, object listEntry)
        {
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.Cluster:
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this EBML model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.DocType:
                    model.DocType = reader.ReadString();
                    break;
                case MatroskaSpecification.DocTypeReadVersion:
                    model.DocTypeReadVersion = reader.ReadULong();
                    break;
                case MatroskaSpecification.DocTypeVersion:
                    model.DocTypeVersion = reader.ReadULong();
                    break;
                case MatroskaSpecification.EBMLMaxIDLength:
                    model.EBMLMaxIDLength = reader.ReadULong();
                    break;
                case MatroskaSpecification.EBMLMaxSizeLength:
                    model.EBMLMaxSizeLength = reader.ReadULong();
                    break;
                case MatroskaSpecification.EBMLReadVersion:
                    model.EBMLReadVersion = reader.ReadULong();
                    break;
                case MatroskaSpecification.EBMLVersion:
                    model.EBMLVersion = reader.ReadULong();
                    break;
                default:
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this DocTypeExtension model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.DocTypeExtensionName:
                    model.DocTypeExtensionName = reader.ReadString();
                    break;
                case MatroskaSpecification.DocTypeExtensionVersion:
                    model.DocTypeExtensionVersion = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this AttachedFile model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                ...
                case MatroskaSpecification.FileDescription:
                    model.FileDescription = reader.ReadString();
                    break;
                case MatroskaSpecification.FileMimeType:
                    model.FileMimeType = reader.ReadString();
                    break;
                ...
                case MatroskaSpecification.FileUID:
                    model.FileUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.FileUsedEndTime:
                    model.FileUsedEndTime = reader.ReadULong();
                    break;
                case MatroskaSpecification.FileUsedStartTime:
                    model.FileUsedStartTime = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this EditionEntry model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.EditionFlagDefault:
                    model.EditionFlagDefault = reader.ReadULong();
                    break;
                case MatroskaSpecification.EditionFlagHidden:
                    model.EditionFlagHidden = reader.ReadULong();
                    break;
                case MatroskaSpecification.EditionFlagOrdered:
                    model.EditionFlagOrdered = reader.ReadULong();
                    break;
                case MatroskaSpecification.EditionUID:
                    model.EditionUID = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Cluster model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.Position:
                    model.Position = reader.ReadULong();
                    break;
                case MatroskaSpecification.PrevSize:
                    model.PrevSize = reader.ReadULong();
                    break;
                case MatroskaSpecification.Timestamp:
                    model.Timestamp = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this BlockGroup model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this BlockMore model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.BlockAddID:
                    model.BlockAddID = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ReferenceFrame model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ReferenceOffset:
                    model.ReferenceOffset = reader.ReadULong();
                    break;
                case MatroskaSpecification.ReferenceTimestamp:
                    model.ReferenceTimestamp = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this TimeSlice model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.BlockAdditionID:
                    model.BlockAdditionID = reader.ReadULong();
                    break;
                case MatroskaSpecification.Delay:
                    model.Delay = reader.ReadULong();
                    break;
                case MatroskaSpecification.FrameNumber:
                    model.FrameNumber = reader.ReadULong();
                    break;
                case MatroskaSpecification.LaceNumber:
                    model.LaceNumber = reader.ReadULong();
                    break;
                case MatroskaSpecification.SliceDuration:
                    model.SliceDuration = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this SilentTracks model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.SilentTrackNumber:
                    model.SilentTrackNumber = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this CuePoint model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.CueTime:
                    model.CueTime = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this CueTrackPositions model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.CueBlockNumber:
                    model.CueBlockNumber = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueClusterPosition:
                    model.CueClusterPosition = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueCodecState:
                    model.CueCodecState = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueDuration:
                    model.CueDuration = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueRelativePosition:
                    model.CueRelativePosition = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueTrack:
                    model.CueTrack = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this CueReference model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.CueRefCluster:
                    model.CueRefCluster = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueRefCodecState:
                    model.CueRefCodecState = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueRefNumber:
                    model.CueRefNumber = reader.ReadULong();
                    break;
                case MatroskaSpecification.CueRefTime:
                    model.CueRefTime = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Info model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ChapterTranslate model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ChapterTranslateCodec:
                    model.ChapterTranslateCodec = reader.ReadULong();
                    break;
                case MatroskaSpecification.ChapterTranslateEditionUID:
                    model.ChapterTranslateEditionUID = reader.ReadULong();
                    break;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Seek model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                ...
                case MatroskaSpecification.SeekPosition:
                    model.SeekPosition = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Targets model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.TagAttachmentUID:
                    model.TagAttachmentUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.TagChapterUID:
                    model.TagChapterUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.TagEditionUID:
                    model.TagEditionUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.TagTrackUID:
                    model.TagTrackUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.TargetType:
                    model.TargetType = reader.ReadString();
                    break;
                case MatroskaSpecification.TargetTypeValue:
                    model.TargetTypeValue = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this TrackEntry model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                ...
                case MatroskaSpecification.TrickMasterTrackUID:
                    model.TrickMasterTrackUID = reader.ReadULong();
                    break;
                case MatroskaSpecification.TrickTrackFlag:
                    model.TrickTrackFlag = reader.ReadULong();
                    break;
                ...
                case MatroskaSpecification.TrickTrackUID:
                    model.TrickTrackUID = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Audio model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.BitDepth:
                    model.BitDepth = reader.ReadULong();
                    break;
                ...
                case MatroskaSpecification.Channels:
                    model.Channels = reader.ReadULong();
                    break;
                case MatroskaSpecification.OutputSamplingFrequency:
                    model.OutputSamplingFrequency = reader.ReadFloat();
                    break;
                case MatroskaSpecification.SamplingFrequency:
                    model.SamplingFrequency = reader.ReadFloat();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this BlockAdditionMapping model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                ...
                case MatroskaSpecification.BlockAddIDName:
                    model.BlockAddIDName = reader.ReadString();
                    break;
                case MatroskaSpecification.BlockAddIDType:
                    model.BlockAddIDType = reader.ReadULong();
                    break;
                case MatroskaSpecification.BlockAddIDValue:
                    model.BlockAddIDValue = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ContentEncodingItem model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ContentEncodingOrder:
                    model.ContentEncodingOrder = reader.ReadULong();
                    break;
                case MatroskaSpecification.ContentEncodingScope:
                    model.ContentEncodingScope = reader.ReadULong();
                    break;
                case MatroskaSpecification.ContentEncodingType:
                    model.ContentEncodingType = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ContentCompression model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ContentCompAlgo:
                    model.ContentCompAlgo = reader.ReadULong();
                    break;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ContentEncryption model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ContentEncAlgo:
                    model.ContentEncAlgo = reader.ReadULong();
                    break;
                ...
                case MatroskaSpecification.ContentSigAlgo:
                    model.ContentSigAlgo = reader.ReadULong();
                    break;
                case MatroskaSpecification.ContentSigHashAlgo:
                    model.ContentSigHashAlgo = reader.ReadULong();
                    break;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this ContentEncAESSettings model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.AESSettingsCipherMode:
                    model.AESSettingsCipherMode = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this TrackPlane model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.TrackPlaneType:
                    model.TrackPlaneType = reader.ReadULong();
                    break;
                case MatroskaSpecification.TrackPlaneUID:
                    model.TrackPlaneUID = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this TrackJoinBlocks model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.TrackJoinUID:
                    model.TrackJoinUID = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this TrackTranslate model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.TrackTranslateCodec:
                    model.TrackTranslateCodec = reader.ReadULong();
                    break;
                case MatroskaSpecification.TrackTranslateEditionUID:
                    model.TrackTranslateEditionUID = reader.ReadULong();
                    break;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Video model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Colour model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this MasteringMetadata model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FillScalar(this Projection model, ElementDescriptor descriptor, int size, SpanReader reader)
        {
            if (descriptor.Type == ElementType.MasterElement)
                throw new InvalidOperationException("Can't read master elements directly from the reader");
            ...
            switch (descriptor.Identifier.EncodedValue) {
                case MatroskaSpecification.ProjectionPosePitch:
                    model.ProjectionPosePitch = reader.ReadFloat();
                    break;
                case MatroskaSpecification.ProjectionPoseRoll:
                    model.ProjectionPoseRoll = reader.ReadFloat();
                    break;
                case MatroskaSpecification.ProjectionPoseYaw:
                    model.ProjectionPoseYaw = reader.ReadFloat();
                    break;
                ...
                case MatroskaSpecification.ProjectionType:
                    model.ProjectionType = reader.ReadULong();
                    break;
                default:
                    throw new EbmlDataFormatException($"Unexpected ebml element '{descriptor.Identifier}'");
            }
