...
import type { RpcPeer } from './actuallab-rpc/rpc-peer.js';
 ...
 */
export class RpcLiveStreamSender<T> implements IRpcObject {
   ...
   */
    ...
    sendEnd(error?: Error | null): void {
        ...
        const errorInfo = error
            ...
            : { TypeRef: '', Message: '' };
        this.peer.hub.systemCallSender.end(conn, this.peer.format, this.id.localId, this._nextIndex, errorInfo);
    }
