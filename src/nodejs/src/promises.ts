 ...
 * race per-iteration (e.g. `pacedEncodedBuffer` calling this once per
 * chunk) won't accumulate listeners or hit Node's `MaxListenersExceeded`
 * warning. The cache is a `WeakMap` so signals are GC-eligible normally.
 *
