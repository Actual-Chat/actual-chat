...
{
    [DataMember, MemoryPackOrder(0), Key(0)] public AuthorId? AuthorId { get; init; }
    [DataMember, MemoryPackOrder(1), Key(1)] public string AuthorName { get; init; } = "";
    [DataMember, MemoryPackOrder(2), Key(2)] public bool HasLeft { get; init; }
