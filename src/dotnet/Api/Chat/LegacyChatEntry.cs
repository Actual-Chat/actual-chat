    ...
    ) : IHasId<ChatEntryId>, IHasVersion<long>
{
    ...
    [DataMember(Order = 37), MemoryPackOrder(37)] public string? AudioId { get; init; }
    ...
    [DataMember(Order = 50), MemoryPackOrder(50)] public ChatEntryAttachment[] Attachments { get; init; } = [];
    [DataMember(Order = 52), MemoryPackOrder(52)] public LinkPreview[] LinkPreviews { get; init; } = [];
    [DataMember(Order = 53), MemoryPackOrder(53)] public ChatEntryAttachment[] AttachmentUploads { get; init; } = [];
