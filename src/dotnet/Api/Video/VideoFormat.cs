...
public partial record VideoFormat : MediaFormat
{
    ...
    [DataMember(Order = 10), MemoryPackOrder(10), NbKey(10)] public string Codec { get; init; } = "avc1"; // H.264 by default
    [DataMember(Order = 11), MemoryPackOrder(11), NbKey(11)] public int Width { get; init; }
    [DataMember(Order = 12), MemoryPackOrder(12), NbKey(12)] public int Height { get; init; }
    [DataMember(Order = 13), MemoryPackOrder(13), NbKey(13)] public string CodecSettings { get; init; } = "";
    ...
    [DataMember(Order = 14), MemoryPackOrder(14), NbKey(14)] public int SourceWidth { get; init; }
    [DataMember(Order = 15), MemoryPackOrder(15), NbKey(15)] public int SourceHeight { get; init; }
