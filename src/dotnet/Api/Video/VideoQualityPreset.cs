...
public sealed partial record VideoQualityPreset(
    ...
    [property: DataMember, MemoryPackOrder(3), Key(3)] bool IsKeyFrameRequested = false,
    ...
    [property: DataMember, MemoryPackOrder(4), Key(4)] int MaxSpatialLayer = int.MaxValue,
    [property: DataMember, MemoryPackOrder(5), Key(5)] int MaxTemporalLayer = int.MaxValue,
    ...
    [property: DataMember, MemoryPackOrder(6), Key(6)] int ViewerCount = 0
) {
