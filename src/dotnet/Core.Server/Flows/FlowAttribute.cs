...
{
    public double ResumeTimeout { get; set; } = double.NaN; // In seconds, NaN means default
    public double DelayQuanta { get; set; } = double.NaN; // In seconds, NaN means "use AutoDelayQuanta.For(delay)"
