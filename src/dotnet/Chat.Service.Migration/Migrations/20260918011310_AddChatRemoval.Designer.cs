...
[Migration("20260918011310_AddChatRemoval")]
partial class _20260918011310_AddChatRemoval
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("ActualChat.Chat.Db.DbChat", b =>
            {
                ...
                b.Property<bool>("IsRemoving")
                    .HasColumnType("boolean")
                    .HasColumnName("is_removing");
                ...
                b.Property<long>("MinVisibleEntryLid")
                    .HasColumnType("bigint")
                    .HasColumnName("min_visible_entry_lid");
