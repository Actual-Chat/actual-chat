...
namespace ActualChat.Chat.Migrations
{
    ...
    [Migration("20250311173217_ChatEntryLanguageDetectionIndex")]
    partial class ChatEntryLanguageDetectionIndex
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActualChat.Chat.Db.DbChatEntry", b =>
                {
                    ...
                    b.HasIndex("ChatId")
                        .HasDatabaseName("ix_chat_entries_chat_id")
                        .HasFilter("kind = 0 and not is_system_entry and not is_removed and languages is not null and languages != '' and  content != ''");
