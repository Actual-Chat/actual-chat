...
public partial class UpgradeUI : ScopedWorkerBase<UIHub>, IComputeService, INotifyInitialized
{
    private readonly IComputedState<bool> _upgradeRequiredState;
    ...
    {
        SystemProperties = hub.GetRequiredService<ISystemProperties>();
