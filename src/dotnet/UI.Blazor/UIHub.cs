...
public class UIHub : CircuitHub, IDispatcherResolver
{
    ...
    public RenderGate RenderGate => field ??= Services.GetRequiredService<RenderGate>();
    ...
    public DateFormatter DateFormatter => field ??= Services.GetRequiredService<DateFormatter>();
