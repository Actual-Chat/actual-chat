...
export class Share {
    ...
    private static async shareFiles(target: HTMLElement, refs: SharedFile[]) : Promise<void> {
    ...
    private static getFileRefs(target: HTMLElement): SharedFile[] | null {
    ...
    private static getFile(ref: SharedFile): Promise<File> {
    ...
    private static async fetchFile(ref: SharedFile): Promise<File> {
