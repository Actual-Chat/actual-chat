...
export class Feedback {
    ...
    private starEnterListener = (event: Event & { target: Element; }) : void => {
    ...
    private feedbackLeaveListener = (event: Event & {target: Element; }) : void => {
        for (let i = 0; i < this.stars.length; i++) {
    ...
    private feedbackEnterListener = (event: Event & {target: Element; }) : void => {
        for (let i = 0; i < this.stars.length; i++) {
