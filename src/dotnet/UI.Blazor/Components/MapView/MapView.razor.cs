...
public sealed partial class MapView : ComponentBase, IAsyncDisposable
{
    public const string DefaultStyleUrl = "https://tiles.openfreemap.org/styles/liberty";
    ...
    [Parameter] public string StyleUrl { get; set; } = DefaultStyleUrl;
    ...
    {
        if (_jsRef is { } jsRef)
            await jsRef.InvokeVoidAsync("setMarkers", Markers).ConfigureAwait(true);
    }
