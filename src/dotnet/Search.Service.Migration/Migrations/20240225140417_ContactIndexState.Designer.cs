...
namespace ActualChat.Search.Migrations
{
    ...
    [Migration("20240225140417_ContactIndexState")]
    partial class ContactIndexState
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ActualChat.Search.Db.DbContactIndexState", b =>
                {
                    ...
                    b.Property<DateTime>("LastCreatedAt")
                        ...
                        .HasColumnName("last_created_at");

                    b.Property<string>("LastCreatedId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("last_created_id");
