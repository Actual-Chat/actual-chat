...
public partial record ExtractorState(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] EntryGroupBuilder? CurrentGroup,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] EntryGroupBuilder? CurrentChunk)
{
