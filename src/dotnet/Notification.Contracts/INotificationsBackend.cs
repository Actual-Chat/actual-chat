...
public sealed partial record NotificationsBackend_Upsert(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] Notification Notification
...
public sealed partial record NotificationsBackend_UpsertExplicitNotification(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ExplicitNotification Notification
) : ICommand<bool>, IBackendCommand, IHasShardKey<UserId>
{
    [IgnoreDataMember, MemoryPackIgnore]
    public UserId ShardKey => Notification.UserId;
...
public sealed partial record NotificationsBackend_RegisterDevice(
    ...
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] Symbol DeviceId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] DeviceType DeviceType,
    [property: DataMember, MemoryPackOrder(3), NbKey(3)] Symbol SessionHash
) : ICommand<Unit>, IBackendCommand, IHasShardKey<UserId>
{
    [IgnoreDataMember, MemoryPackIgnore]
...
public sealed partial record NotificationsBackend_RemoveDevices(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] Symbol[] DeviceIds
...
public sealed partial record NotificationsBackend_NotifyMembers(
    ...
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] long LastEntryId
) : ICommand<Unit>, IBackendCommand, IHasShardKey<UserId>
{
    [IgnoreDataMember, MemoryPackIgnore]
    public UserId ShardKey => UserId;
...
public sealed partial record NotificationsBackend_NotifyMentionedMembers(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] UserId UserId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] ChatEntryId ChatEntryId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] UserId[] UserIds
) : ICommand<Unit>, IBackendCommand, IHasShardKey<UserId>
{
    [IgnoreDataMember, MemoryPackIgnore]
    public UserId ShardKey => UserId;
