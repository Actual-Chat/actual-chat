...
) : ICommand<Result<ExternalContactFull?>[]>, IBackendCommand, IHasShardKey
{
    [JsonIgnore, Newtonsoft.Json.JsonIgnore, IgnoreDataMember, IgnoreMember]
    public ShardKey ShardKey => Changes.Length > 0
        ? Changes[0].Id.ShardKey
        : throw new ArgumentException("No changes provided", nameof(Changes));
}
...
{
    [JsonIgnore, Newtonsoft.Json.JsonIgnore, IgnoreDataMember, IgnoreMember]
    public ShardKey ShardKey => Id.UserDeviceId.OwnerId.ShardKey;
}
