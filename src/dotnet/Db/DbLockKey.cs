...
public readonly record struct DbLockKey(string LockSpace, int Key)
{
    ...
    public static DbLockKey New<TArg0>(Type lockSpace, TArg0 arg0)
        => new(lockSpace.ToIdentifierSymbol(), StableHash.Compute(arg0));
    public static DbLockKey New<TArg0, TArg1>(Type lockSpace, TArg0 arg0, TArg1 arg1)
        => new(lockSpace.ToIdentifierSymbol(), StableHash.Compute(arg0, arg1));
    public static DbLockKey New<TArg0, TArg1, TArg2>(Type lockSpace, TArg0 arg0, TArg1 arg1, TArg2 arg2)
        => new(lockSpace.ToIdentifierSymbol(), StableHash.Compute(arg0, arg1, arg2));
