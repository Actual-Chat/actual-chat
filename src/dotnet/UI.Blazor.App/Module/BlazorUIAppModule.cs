    ...
    : HostModule(moduleServices), IBlazorUIModule
{
    ...
    protected override void InjectServices(IServiceCollection services)
    {
        ...
        fusion.AddService<MiddlePanel>(ServiceLifetime.Scoped);
        ...
        services.AddAlias<IDebugAudio, ChatAudioUI>(ServiceLifetime.Transient);
        ...
        fusion.AddService<TypingUI>(ServiceLifetime.Scoped);
        fusion.AddService<VoiceActivityUI>(ServiceLifetime.Scoped);
        ...
        services.AddTypeMap<IModalView>(map => map
            ...
            .Add<AppReviewModal.Model, AppReviewModal>()
            ...
            .Add<OAuthConsentModal.Model, OAuthConsentModal>()
            ...
            .Add<ShareQrModalModel, ShareQrModal>()
            ...
            .Add<DigestTimeEditorModal.Model, DigestTimeEditorModal>()
            .Add<DocumentsModal.Model, DocumentsModal>()
            .Add<DubVoiceModal.Model, DubVoiceModal>()
            .Add<ApiKeyCreateModal.Model, ApiKeyCreateModal>()
            .Add<WebHookCreateModal.Model, WebHookCreateModal>()
            .Add<WebHookDetailModal.Model, WebHookDetailModal>()
        ...
        services.AddTypeMap<IModalView>(map => map
            ...
            .Add<PermissionGuideModal.Model, PermissionGuideModal>()
        );
