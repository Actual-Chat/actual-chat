    ...
    : HostModule(moduleServices), IBlazorUIModule
{
    ...
    protected override void InjectServices(IServiceCollection services)
    {
        ...
        services.AddTypeMap<IModalView>(map => map
            ...
            .Add<VideoDiagnosticsSettingsModal.Model, VideoDiagnosticsSettingsModal>()
        ...
        services.AddScoped<IAudioCatchUpPolicy>(c => new LiveAudioCatchUpPolicy(c.GetRequiredService<PlaybackLagTracker>()));
