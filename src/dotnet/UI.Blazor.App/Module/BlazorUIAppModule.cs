    ...
    : HostModule(moduleServices), IBlazorUIModule
{
    ...
    protected override void InjectServices(IServiceCollection services)
    {
        ...
        services.AddScoped(c => new MediaShareUI(c.AppUIHub()));
        services.AddAlias<IMediaShareUI, MediaShareUI>(ServiceLifetime.Scoped);
        ...
        services.AddScoped<AudioSyncDiagnostics>(c => new AudioSyncDiagnostics(c.GetRequiredService<MomentClockSet>()));
