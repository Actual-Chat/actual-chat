...
const mipmapTextureCache: Map<string, GPUTexture> = new Map();
...
const texturePool: Map<string, GPUTexture[]> = new Map();
...
export async function applyBackgroundBlur(
  ...
  maskTex = uploadMaskFromBuffer(encoder, personMask as GPUBuffer, maskWidth, maskHeight);
