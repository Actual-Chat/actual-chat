...
/**
 * Read a GPU buffer mask to CPU Float32Array
 * Use sparingly - this causes GPU->CPU sync
 *
 * @param maskBuffer GPU buffer containing mask data
 * @param maskSize Number of pixels in the mask
