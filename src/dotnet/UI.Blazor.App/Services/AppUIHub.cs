...
public sealed class AppUIHub(IServiceProvider services) : UIHub(services)
{
    ...
    public IChatCallReactions ChatCallReactions => field ??= Services.GetRequiredService<IChatCallReactions>();
    ...
    public CallScreensUI CallScreensUI => field ??= Services.GetRequiredService<CallScreensUI>();
    ...
    public AppReviewPromptUI AppReviewPromptUI => field ??= Services.GetRequiredService<AppReviewPromptUI>();
