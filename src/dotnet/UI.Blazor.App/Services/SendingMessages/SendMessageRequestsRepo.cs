...
{
    [DataMember, MemoryPackOrder(0), Key(0)] public required string Uuid { get; init; }
    ...
    [DataMember, MemoryPackOrder(8), Key(8)] public string AfterSendMessageHandlerKey { get; init; } = "";
    [DataMember, MemoryPackOrder(9), Key(9)] public string AfterSendMessageHandlerArgs { get; init; } = "";
    [DataMember, MemoryPackOrder(10), Key(10)] public long? NewChatEntryLocalId { get; init; }
    [DataMember, MemoryPackOrder(11), Key(11)] public MediaRef[] ExistingMedia { get; init; } = [];
...
public partial record AttachFileRequestEntry(
    [property: DataMember, MemoryPackOrder(0), Key(0)] string UploadSessionId,
    [property: DataMember, MemoryPackOrder(1), Key(1)] string FileName,
    [property: DataMember, MemoryPackOrder(2), Key(2)] string FileType,
    [property: DataMember, MemoryPackOrder(3), Key(3)] long FileLength,
    [property: DataMember, MemoryPackOrder(4), Key(4)] int Width,
    [property: DataMember, MemoryPackOrder(5), Key(5)] int Height
) : IHasId<string>
{
