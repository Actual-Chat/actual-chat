...
public partial class ChatUI
{
        ...
        out bool hasMoreAfter1)
    {
        conversationView = TruncateMaterializedRanges(conversationView,
            chatRangeMeta1.SelectMany(m => m.ConversationLidRanges).Concat(blocks.Select(b => b.EntryLidRange)));
        ...
        if (showConversations) {
            ...
            hasFulfilledStart &= !hasPreviousIdTile || startEntryLid >= chatRangeMeta1[0].LidRange.Start;
            hasFulfilledEnd &= !hasNextIdTile || endEntryLid < chatRangeMeta1[^1].LidRange.End;
        }
