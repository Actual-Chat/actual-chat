...
/// <see cref="Stop"/> ends it, <see cref="Get"/> returns the tracked one or queries the platform
...
public interface ILocationTracker
{
    ...
    Task<GeoPoint?> Get(bool mustBeFresh = false, CancellationToken cancellationToken = default);
