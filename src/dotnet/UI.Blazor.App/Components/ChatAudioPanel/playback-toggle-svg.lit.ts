...
class PlaybackToggleSvg extends LitElement {
    ...
    protected render(): unknown {
        ...
        if (this.isOn)
            return html`
                <svg class="playback-toggle-svg spin-and-on ${this.isOn ? 'on' : ''}" width="${this.size}" height="${this.size}" viewBox="${this.viewBox}" xmlns="http://www.w3.org/2000/svg">
        ...
        if (!this.isAnimated)
            return html`
                <svg class="playback-toggle-svg" width="${this.size}" height="${this.size}" viewBox="${this.viewBox}" xmlns="http://www.w3.org/2000/svg">
