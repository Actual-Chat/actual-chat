...
public class DefaultVisualMediaGalleryArranger : IVisualMediaGalleryArranger
{
    public VisualMediaGalleryLine<TItem>[] Arrange<TItem>(IReadOnlyCollection<TItem> items, Func<TItem, (int width, int height)> getSize)
    {
        ...
        foreach (var item in items) {
            ...
            var lineHasManyWide = resultBuilder.Line.Count(t => t.Proportions is VisualMediaProportions.Wide or VisualMediaProportions.ExtraWide) > 1;
