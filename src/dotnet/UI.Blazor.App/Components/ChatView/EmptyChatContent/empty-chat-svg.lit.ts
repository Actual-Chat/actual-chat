    ...
    protected render(): unknown {
        return html`
            <svg width="187" height="185" viewBox="0 0 187 185" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path class="left-paw" d="M42.1548 175.027L46.1407 175.873L59.8501 172.612L89.0203 162.345L103.575 155.037L106.655 151.112L100.314 142.415L96.7506 139.637L78.3306 149.541L67.8825 153.225L59.4274 153.89L52.7237 155.52L46.1407 158.902L37.9876 165.304L37.1421 170.317L42.1548 175.027Z" fill="var(--empty-chat-cat-body)"/>
