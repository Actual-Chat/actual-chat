...
public static class LocalizedStringsLocalizerExt
{
    extension(IStringLocalizer l)
    {
        ...
        public string Settings_UILanguageApplyTitle => l["Settings_UILanguageApplyTitle"].Value;
        public string Settings_UILanguageReloadText => l["Settings_UILanguageReloadText"].Value;
        ...
        public string WebHook_DeliveryRepeats_Format(object arg0)
            => l["WebHook_DeliveryRepeats_Format", arg0].Value;
        ...
        public string ImageGeneration_Title => l["ImageGeneration_Title"].Value;
        public string ImageGeneration_DescriptionPlaceholder => l["ImageGeneration_DescriptionPlaceholder"].Value;
        public string ImageGeneration_Style => l["ImageGeneration_Style"].Value;
        public string ImageGeneration_Generate => l["ImageGeneration_Generate"].Value;
        public string PicCrop_ChatPictureTitle => l["PicCrop_ChatPictureTitle"].Value;
        public string ImageStyle_Default => l["ImageStyle_Default"].Value;
        public string ImageStyle_Random => l["ImageStyle_Random"].Value;
        public string ImageStyle_None => l["ImageStyle_None"].Value;
        public string ImageStyle_FlatVector => l["ImageStyle_FlatVector"].Value;
        public string ImageStyle_LineArt => l["ImageStyle_LineArt"].Value;
        public string ImageStyle_Minimalist => l["ImageStyle_Minimalist"].Value;
        public string ImageStyle_Risograph => l["ImageStyle_Risograph"].Value;
        public string ImageStyle_Cartoon => l["ImageStyle_Cartoon"].Value;
        public string ImageStyle_Anime => l["ImageStyle_Anime"].Value;
        public string ImageStyle_Ghibli => l["ImageStyle_Ghibli"].Value;
        public string ImageStyle_ComicBook => l["ImageStyle_ComicBook"].Value;
        public string ImageStyle_Watercolor => l["ImageStyle_Watercolor"].Value;
        public string ImageStyle_OilPainting => l["ImageStyle_OilPainting"].Value;
        public string ImageStyle_PencilSketch => l["ImageStyle_PencilSketch"].Value;
        public string ImageStyle_FantasyArt => l["ImageStyle_FantasyArt"].Value;
        public string ImageStyle_Isometric => l["ImageStyle_Isometric"].Value;
        public string ImageStyle_LowPoly => l["ImageStyle_LowPoly"].Value;
        public string ImageStyle_Render3D => l["ImageStyle_Render3D"].Value;
        public string ImageStyle_Claymation => l["ImageStyle_Claymation"].Value;
        public string ImageStyle_Papercut => l["ImageStyle_Papercut"].Value;
        public string ImageStyle_StainedGlass => l["ImageStyle_StainedGlass"].Value;
        public string ImageStyle_PixelArt => l["ImageStyle_PixelArt"].Value;
        public string ImageStyle_Photo => l["ImageStyle_Photo"].Value;
        public string ImageStyle_Cinematic => l["ImageStyle_Cinematic"].Value;
        public string ImageStyle_NeonCyberpunk => l["ImageStyle_NeonCyberpunk"].Value;

        public string PicCrop_Description => l["PicCrop_Description"].Value;
        public string PicCrop_Regenerate => l["PicCrop_Regenerate"].Value;
        public string PicCrop_GenerationFailed => l["PicCrop_GenerationFailed"].Value;
        ...
        public string Call_Entry_Incoming => l["Call_Entry_Incoming"].Value;
        public string Call_Entry_Titled_Format(object arg0, object arg1)
            => l["Call_Entry_Titled_Format", arg0, arg1].Value;
