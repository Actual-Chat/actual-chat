...
public sealed class TextEntryIndexer(IServiceProvider services) : WorkerBase, IHasServices, INotifyInitialized
{
    ...
    private IMeshLocks<MLSearchDbContext>? _meshLocks;
    ...
    private IMeshLocks<MLSearchDbContext> MeshLocks
        => _meshLocks ??= Services.GetRequiredService<IMeshLocks<MLSearchDbContext>>();
