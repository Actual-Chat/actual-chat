...
public class DbSessionInfoConverterBase<TDbSessionInfo, TDbUserId>(IServiceProvider services)
    : DbEntityConverter<UsersDbContext, TDbSessionInfo, SessionInfo>(services)
