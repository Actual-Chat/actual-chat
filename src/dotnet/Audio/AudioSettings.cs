...
public sealed class AudioSettings
{
    ...
    public TimeSpan IdleRecordingTimeout { get; set; } = TimeSpan.FromSeconds(180);
    public TimeSpan IdleRecordingPreCountdownTimeout { get; set; } = TimeSpan.FromSeconds(150);
