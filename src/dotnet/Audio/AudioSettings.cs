...
public sealed class AudioSettings
{
    ...
    public TimeSpan IdleRecordingTimeout { get; set; } = TimeSpan.FromMinutes(1.5);
    public TimeSpan IdleRecordingTimeoutBeforeCountdown { get; set; } = TimeSpan.FromMinutes(1);
    public TimeSpan IdleRecordingCheckInterval { get; set; } = TimeSpan.FromSeconds(1);
    public TimeSpan IdleListeningTimeout { get; set; } = TimeSpan.FromMinutes(3);
