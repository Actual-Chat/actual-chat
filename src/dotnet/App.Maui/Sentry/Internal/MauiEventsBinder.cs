...
internal class MauiEventsBinder : IMauiEventsBinder
{
    ...
    public void BindApplicationEvents(Application application)
    {
        ...
        application.PageAppearing += (sender, page) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Application.PageAppearing),
                NavigationType,
                NavigationCategory,
        ...
        application.PageDisappearing += (sender, page) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Application.PageDisappearing),
                NavigationType,
                NavigationCategory,
                data => data.AddElementInfo(_options, page, nameof(Page)));
        application.ModalPushing += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Application.ModalPushing),
                NavigationType,
                NavigationCategory,
        ...
        application.ModalPopping += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Application.ModalPopping),
                NavigationType,
                NavigationCategory,
                data => data.AddElementInfo(_options, e.Modal, nameof(e.Modal)));
        application.ModalPopped += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Application.ModalPopped),
                NavigationType,
                NavigationCategory,
                data => data.AddElementInfo(_options, e.Modal, nameof(e.Modal)));
    ...
    public void BindWindowEvents(Window window)
    {
        ...
        window.Deactivated += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Deactivated),
                SystemType,
                LifecycleCategory);
        window.Stopped += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Stopped),
                SystemType,
                LifecycleCategory);
        window.Resumed += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Resumed),
                SystemType,
                LifecycleCategory);
        ...
        window.Created += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Created),
                SystemType,
                LifecycleCategory);
        window.Destroying += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Destroying),
                SystemType,
                LifecycleCategory);
        window.Backgrounding += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.Backgrounding),
                SystemType,
                LifecycleCategory,
                data => {
        ...
        window.DisplayDensityChanged += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Window.DisplayDensityChanged),
                SystemType,
                LifecycleCategory,
                data => {
    ...
    public void BindElementEvents(Element element)
    {
        ...
        element.HandlerChanging += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Element.HandlerChanging),
                SystemType,
                HandlersCategory,
                data => {
    ...
    public void BindPageEvents(Page page)
    {
        ...
        page.NavigatingFrom += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Page.NavigatingFrom),
                NavigationType,
                NavigationCategory);
        page.NavigatedFrom += (sender, e) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Page.NavigatedFrom),
                NavigationType,
                NavigationCategory,
    ...
    public void BindButtonEvents(Button button)
    {
        ...
        button.Pressed += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Button.Pressed),
                UserType,
                UserActionCategory);
        button.Released += (sender, _) =>
            _hub.AddBreadcrumbForEvent(_options,
                sender,
                nameof(Button.Released),
                UserType,
                UserActionCategory);
    }
}
