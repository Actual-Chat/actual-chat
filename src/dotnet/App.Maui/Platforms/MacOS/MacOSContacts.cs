...
// TODO(maui-labs): delete once Essentials' Contacts is implemented on the macos TFM - MauiContacts then applies.
/// <summary>
/// <see cref="MauiContacts"/> on CNContactStore, which the labs Essentials package doesn't implement.
/// </summary>
