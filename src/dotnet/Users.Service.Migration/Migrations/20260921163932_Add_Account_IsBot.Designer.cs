...
[Migration("20260921163932_Add_Account_IsBot")]
partial class _20260921163932_Add_Account_IsBot
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("ActualChat.Users.Db.DbAccount", b =>
            {
                ...
                b.HasIndex("IsBot")
                    .HasDatabaseName("ix_accounts_is_bot");
        ...
        modelBuilder.Entity("ActualChat.Users.Db.DbUsageDay", b =>
            {
                b.Property<string>("UserId")
                    .HasColumnType("text")
                    .HasColumnName("user_id")
                ...
                b.Property<int>("ContactsAdded")
                    .HasColumnType("integer")
                    .HasColumnName("contacts_added");

                b.Property<int>("ContactsRemoved")
                    .HasColumnType("integer")
                    .HasColumnName("contacts_removed");

                b.Property<int>("LiveSessions")
                    .HasColumnType("integer")
                    .HasColumnName("live_sessions");

                b.Property<int>("Messages")
                    .HasColumnType("integer")
                    .HasColumnName("messages");

                b.Property<int>("SpeechEntries")
                    .HasColumnType("integer")
                    .HasColumnName("speech_entries");

                b.Property<long>("SpeechMs")
                    .HasColumnType("bigint")
                    .HasColumnName("speech_ms");
        ...
        modelBuilder.Entity("ActualChat.Users.Db.DbUsageEvent", b =>
            {
                b.Property<string>("UserId")
                    .HasColumnType("text")
                    .HasColumnName("user_id")
                ...
                b.HasIndex("UserId", "Kind", "SourceId")
                    .IsUnique()
                    .HasDatabaseName("ix_usage_events_user_id_kind_source_id");
