...
namespace ActualChat.Users.Migrations
{
    ...
    [Migration("20260123192256_DbAccount_Add_FormatVersion")]
    partial class DbAccount_Add_FormatVersion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ActualChat.Users.Db.DbRouletteCompletion", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id")
                    ...
                    b.Property<bool>("IsInitiatedByOwner")
                        .HasColumnType("boolean")
                        .HasColumnName("is_initiated_by_owner");
                    ...
                    b.Property<string>("PeerProfileId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("peer_profile_id")
                        .UseCollation("C");

                    b.Property<string>("PeerUserId")
                        .IsRequired()
                        .HasColumnType("text")
                        .HasColumnName("peer_user_id")
                        .UseCollation("C");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_roulette_completions");

                    b.ToTable("roulette_completions");
                });
            ...
            modelBuilder.Entity("ActualChat.Users.Db.DbRouletteUserSettings", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_roulette_user_settings");

                    b.ToTable("roulette_user_settings");
                });
