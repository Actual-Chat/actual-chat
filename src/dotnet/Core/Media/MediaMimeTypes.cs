...
{
    private static readonly Dictionary<string, string> Types = GetTypes();
    private static readonly Dictionary<string, string> Extensions = GetExtensions();

    static MediaMimeTypes()
        => Register("application/x-zip-compressed", ".zip");
    ...
    private static void Register(string mimeType, string extension)
    {
