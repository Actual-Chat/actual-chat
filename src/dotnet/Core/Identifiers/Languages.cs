...
public static class Languages
{
    ...
    public static readonly Language EnglishUK    = new("en-GB", "EN", "English (United Kingdom)", AssumeValid.Option);
    public static readonly Language EnglishIN    = new("en-IN", "EN", "English (India)", AssumeValid.Option);
    public static readonly Language French       = new("fr-FR", "FR", "French", AssumeValid.Option);
    public static readonly Language FrenchCA     = new("fr-CA", "FR", "French (Canada)", AssumeValid.Option);
    ...
    public static readonly Language PortugueseBR = new("pt-BR", "PT", "Portuguese (Brazil)", AssumeValid.Option);
    ...
    public static readonly Language SpanishMX    = new("es-MX", "ES", "Spanish (Mexico)", AssumeValid.Option);
