    ...
    where TKey : notnull
{
    ...
    public ThreadSafeLruCache(int capacity, IEqualityComparer<TKey>? comparer = null, Action<TKey, TValue>? evictionHandler = null)
        : this(new LruCache<TKey, TValue>(capacity, comparer, evictionHandler))
    { }
