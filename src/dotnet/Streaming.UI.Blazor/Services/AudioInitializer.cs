...
{
    private static readonly string JSInitMethod = $"{StreamingBlazorUIModule.ImportName}.AudioInitializer.init";
    private static readonly string JSUpdateBackgroundStateMethod = $"{StreamingBlazorUIModule.ImportName}.AudioInitializer.setBackgroundState";
