...
public class MjmlSection : ComponentBase
{
    ...
    [Parameter] public MjmlSectionBackgroundRepeat? BackgroundRepeat { get; set; }
    ...
    [Parameter] public MjmlSectionDirection? Direction { get; set; }
    [Parameter] public MjmlSectionFullWidth? FullWidth { get; set; }
    ...
    [Parameter] public MjmlSectionTextAlign? TextAlign { get; set; }
    [Parameter] public string? TextPadding { get; set; }
    [Parameter] public RenderFragment? ChildContent { get; set; }

    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        builder.OpenElement(0, "mj-section");
