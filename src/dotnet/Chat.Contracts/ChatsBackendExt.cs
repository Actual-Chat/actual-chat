...
public static class ChatsBackendExt
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var idTiles = Constants.Chat.EntryIdTileLayer.GetCoveringTiles(new Range<long>(minId, maxId + 1));
    ...
    public static async Task<IReadOnlyList<ChatEntry>> ListEntries(
        ...
        CancellationToken cancellationToken = default)
    {
        var idTiles = Constants.Chat.EntryIdTileLayer.GetCoveringTiles(lidRange);
