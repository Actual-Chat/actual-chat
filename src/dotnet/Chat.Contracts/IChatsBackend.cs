...
public sealed partial record ChatsBackend_CreateAttachments(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)]
...
public sealed partial record ChatsBackend_Change(
    ...
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] Change<ChatDiff> Change,
    [property: DataMember, MemoryPackOrder(3), NbKey(3)] UserId? OwnerId = null
...
public sealed partial record ChatsBackend_ChangeEntry(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatEntryId ChatEntryId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] long? ExpectedVersion,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] Change<ChatEntryDiff> Change
...
public sealed partial record ChatBackend_CopyChat(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatId ChatId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] PlaceId PlaceId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] string CorrelationId
...
public sealed partial record ChatBackend_CopyChatResult(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] bool HasChanges,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] bool HasErrors,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] long LastProcessedEntryId
);
...
public sealed partial record ChatsBackend_ChangeChatCopyState(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatId ChatId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] long? ExpectedVersion,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] Change<ChatCopyStateDiff> Change
...
public sealed partial record ChatsBackend_UpdateReadPositionsStat(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatId ChatId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] UserId UserId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] long EntryLid
) : ICommand<Unit>, IBackendCommand, IHasShardKey<ChatId>
{
    [IgnoreDataMember, MemoryPackIgnore]
    public ChatId ShardKey => ChatId;
...
public sealed partial record ChatsBackend_RetranscribeChatEntry(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatEntryId EntryId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] Language Language
) : ICommand<Unit>, IBackendCommand, IHasShardKey<ChatId>
{
    [IgnoreDataMember, MemoryPackIgnore]
    public ChatId ShardKey => EntryId.ChatId;
