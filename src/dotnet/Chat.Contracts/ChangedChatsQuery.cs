...
{
    [DataMember, MemoryPackOrder(2), NbKey(2)] public required ChatId? LastId { get; init; }
    ...
    [DataMember, MemoryPackOrder(4), NbKey(4)] public bool ExcludePeerChats { get; init; }
    [DataMember, MemoryPackOrder(5), NbKey(5)] public bool ExcludePlaceRootChats { get; init; }
}
