...
public partial record ChangedAuthorsQuery
{
    ...
    [DataMember, MemoryPackOrder(2), NbKey(2)] public AuthorId? LastId { get; init; }
    [DataMember, MemoryPackOrder(3), NbKey(3)] public int Limit { get; init; }
    [DataMember, MemoryPackOrder(4), NbKey(4)] public bool? IsPlaceAuthor { get; init; }
}
