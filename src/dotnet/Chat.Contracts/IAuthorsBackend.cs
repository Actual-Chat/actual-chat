...
public sealed partial record AuthorsBackend_Upsert(
    ...
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] AuthorId? AuthorId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] UserId? UserId,
    [property: DataMember, MemoryPackOrder(3), NbKey(3)] long? ExpectedVersion,
    [property: DataMember, MemoryPackOrder(4), NbKey(4)] AuthorDiff Diff,
    [property: DataMember, MemoryPackOrder(5), NbKey(5)] bool DoNotNotify = false
...
public sealed partial record AuthorsBackend_Remove(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatId? ByChatId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] AuthorId? ByAuthorId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] UserId? ByUserId
...
public sealed partial record AuthorsBackend_CopyChat(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] ChatId OldChatId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] ChatId NewChatId,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] (RoleId, RoleId)[] RolesMap,
    [property: DataMember, MemoryPackOrder(3), NbKey(3)] string CorrelationId
