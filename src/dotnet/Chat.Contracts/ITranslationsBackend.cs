...
public sealed partial record TranslationsBackend_Change(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] TranslationId Id,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] long? ExpectedVersion,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] Change<TranslationDiff> Change) : ICommand<Translation>, IBackendCommand, IHasShardKey<TranslationSourceId>
{
...
public sealed partial record TranslationsBackend_Translate(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] TranslationSourceId SourceId,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] Language TargetLanguage,
    [property: DataMember, MemoryPackOrder(2), NbKey(2)] bool OverwriteIfVersionMismatch,
    [property: DataMember, MemoryPackOrder(3), NbKey(3)] bool SkipRealtimeTranslation
...
public sealed partial record TranslationsBackend_TranslateStream(
    [property: DataMember, MemoryPackOrder(0), NbKey(0)] StreamId Id,
    [property: DataMember, MemoryPackOrder(1), NbKey(1)] Language TargetLanguage
