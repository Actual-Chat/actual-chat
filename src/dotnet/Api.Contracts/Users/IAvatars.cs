...
{
    [ComputeMethod(MinCacheDuration = 10), RemoteComputeMethod(CacheMode = RemoteComputedCacheMode.Cache)]
    ...
    [ComputeMethod]
    Task<Symbol[]> ListOwnAvatarIds(Session session, CancellationToken cancellationToken);
