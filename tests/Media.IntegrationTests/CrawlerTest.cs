    ...
    : SharedAppHostTestBase<AppHostFixture>(fixture, @out)
{
    ...
    private string Authority1 { get; } = $"https://domain_{RandomStringGenerator.Next(3)}.some";
    private string Authority2 { get; } = $"https://domain_{RandomStringGenerator.Next(3)}.some";
    ...
    {
        // arrange
        var url1 = $"{Authority1}/{RandomStringGenerator.Next()}";
        var url2 = $"{Authority1}/{RandomStringGenerator.Next()}";
        var imgUrl = $"{Authority2}/images/{RandomStringGenerator.Next()}.jpg";
        Http.SetupImage(imgUrl)
