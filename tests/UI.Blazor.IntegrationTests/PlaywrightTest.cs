...
public class PlaywrightTest : AppHostTestBase
{
    ...
    public async Task AddMessageTest()
    {
        ...
        var chatPage = await page.QuerySelectorAsync(".chat-page-common").ConfigureAwait(false);
        ...
        static async Task<IReadOnlyList<IElementHandle>> GetMessages(IPage page)
            => await page.QuerySelectorAllAsync(".chat-page-common .content-common");
    ...
    public async Task ChatPageTest()
    {
        ...
        var messages = await page.QuerySelectorAllAsync(".chat-page-common .content-common");
