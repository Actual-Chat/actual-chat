...
public class FormSectionLocalizationTest
{
    ...
    {
        // OwnAccountEditorModal's alias field is exactly this case: the framework names
        // the field after the member, and the label the user reads is something else.
