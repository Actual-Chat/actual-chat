...
namespace ActualChat.Tests.Transcription
{
    public class StablePrefixCutterTest : TestBase
    {
        ...
        public void RepeatTest()
        {
            ...
            cutter.CutMemoized(("раз-два-три, раз-два-три,", 6.500));
            cutter.CutMemoized(("раз-два-три", 1.800));
            cutter.CutMemoized(("раз-два-три", 2.400));
            cutter.CutMemoized(("кто-то", 6.100));
            var r16 = cutter.CutMemoized(("был", 6.600));
            r16.Text.Should().Be(" был");
            r16.TextIndex.Should().Be(30);
