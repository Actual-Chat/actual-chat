...
public static class ExternalContactOperations
{
    ...
    public static async Task<ApiArray<ExternalContactFull>> DeleteExternalContacts(this IWebTester tester, params IEnumerable<ExternalContactId> externalContactIds)
    {
