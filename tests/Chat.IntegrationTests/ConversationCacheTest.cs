    ...
    : SharedAppHostTestBase<AppHostFixture>(fixture, @out)
{
    ...
    public async Task RangeMetaSurvivesLiveStateChangeThatCannotMoveTheBlock()
    {
        ...
        var cTile = await Computed.Capture(
            () => conversations.GetTile(chatId, RangeIdTileLayer.GetTile(tileStart).Range, default));
        ...
        StartLiveSession()
    {
        ...
        return (chatId, RangeIdTileLayer.GetTile(state.EffectiveVisibleStartLid).Start, live, conversations);
    }
}
