...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      '5xl': ['3rem', { lineHeight: '3.75rem', fontWeight: '600' }],
      '5.5xl': ['3.5rem', { lineHeight: '1' }],
      '6xl': ['3.75rem', { lineHeight: '1' }],
      '7xl': ['4.5rem', { lineHeight: '1' }],
      '8xl': ['6rem', { lineHeight: '1' }],
      '9xl': ['8rem', { lineHeight: '1' }],
      'title-1': ['1.25rem', { lineHeight: '1.5rem', fontWeight: '500' }],
      'headline-1': ['1rem', { lineHeight: '1.25rem', fontWeight: '500' }],
      'headline-2': ['4.5rem', { lineHeight: '5.5rem', fontWeight: '600' }],
      'headline-3': ['3.5rem', { lineHeight: '4.25rem', fontWeight: '600' }],
      'headline-4': ['2.5rem', { lineHeight: '3rem', fontWeight: '600' }],
      'headline-5': ['1.5rem', { lineHeight: '1.75rem', fontWeight: '500' }],
      'headline-6': ['1.5rem', { lineHeight: '1.75rem', fontWeight: '600' }],
      'headline-7': ['1.25rem', { lineHeight: '1.5rem', fontWeight: '500' }],
      'text-1': ['1rem', { lineHeight: '1.25rem', fontWeight: '400' }],
      'caption-1': ['0.875rem', { lineHeight: '1.125rem', fontWeight: '500' }],
      'caption-2': ['0.85rem', { lineHeight: '1.125rem', fontWeight: '400' }],
      'caption-3': ['0.85rem', { lineHeight: '1.125rem', fontWeight: '500' }],
      'caption-4': ['0.875rem', { lineHeight: '1.125rem', fontWeight: '400' }],
      'caption-6': ['0.75rem', { lineHeight: '1rem', fontWeight: '500' }],
      'caption-7': ['0.85rem', { lineHeight: '1.125rem', fontWeight: '600' }],
      'caption-8': ['0.75rem', { lineHeight: '1rem', fontWeight: '400' }],
      'caption-9': ['0.6rem', { lineHeight: '0.75rem', fontWeight: '500' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
