...
const dirs = fs.readdirSync(_('./src/dotnet/'), { withFileTypes: true })
  ...
  .concat(`${_('./src/dotnet/App.Server')}${path.sep}**/*.{razor,cshtml}`);
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'contact-selector-badge': 'var(--contact-selector-badge)',
        'contact-selector-badge-hover': 'var(--contact-selector-badge-hover)',
        'contact-selector-badge-active': 'var(--contact-selector-badge-active)',
        ...
        'cancel-outline': 'var(--cancel-outline)',
        ...
        'menuitem-active': 'var(--menuitem-active)',
        'menuitem-hover-warning': 'var(--menuitem-hover-warning)',
        'cancel-text': 'var(--cancel-text)',
        'after-lighter': 'var(--after-lighter)',
        'after-darker': 'var(--after-darker)',
        'btn-hover': 'var(--btn-hover)',
        'btn-active': 'var(--btn-active)',
        'btn-tint-hover': 'var(--btn-tint-hover)',
        'btn-tint-active': 'var(--btn-tint-active)',
        'btn-tint-danger-hover': 'var(--btn-tint-danger-hover)',
        'btn-tint-danger-active': 'var(--btn-tint-danger-active)',
        'btn-text-primary-hover': 'var(--btn-text-primary-hover)',
        'btn-text-primary-active': 'var(--btn-text-primary-active)',
        'btn-text-danger-hover': 'var(--btn-text-danger-hover)',
        'btn-text-danger-active': 'var(--btn-text-danger-active)',
        'btn-tile-fill': 'var(--btn-tile-fill)',
        'outline-bg-primary': 'var(--outline-bg-primary)',
        'outline-bg-danger': 'var(--outline-bg-danger)',
        'outline-bg-cancel': 'var(--outline-bg-cancel)',
        'hover-after-primary': 'var(--hover-after-primary)',
        'hover-after-danger': 'var(--hover-after-danger)',
        'hover-after-cancel': 'var(--hover-after-cancel)',
        'hover-after-icon': 'var(--hover-after-icon)',
        'focus-after-primary': 'var(--focus-after-primary)',
        'focus-after-danger': 'var(--focus-after-danger)',
        'focus-after-cancel': 'var(--focus-after-cancel)',
        'active-after-primary': 'var(--active-after-primary)',
        'active-after-danger': 'var(--active-after-danger)',
        'active-after-cancel': 'var(--active-after-cancel)',
        'active-after-icon': 'var(--active-after-icon)',
        'active-after-outline-primary': 'var(--active-after-outline-primary)',
        'active-after-outline-danger': 'var(--active-after-outline-danger)',
        'active-after-outline-cancel': 'var(--active-after-outline-cancel)',
      ...
      textColor: {
        ...
        '05': 'var(--text-05)',
        '06': 'var(--text-06)',
        'banner-default': 'var(--text-banner-default)',
      ...
      backgroundColor: {
        ...
        'banner-default': 'var(--background-banner-default)',
        ...
        'banner-default-btn': 'var(--background-banner-default-btn)',
        'banner-warning-btn': 'var(--background-banner-warning-btn)',
        'banner-error-btn': 'var(--background-banner-error-btn)',
        'banner-info-btn': 'var(--background-banner-info-btn)',
        'banner-success-btn': 'var(--background-banner-success-btn)',
    ...
    fontSize: {
      // Raw scale: sizes in rem, line-height unitless (ratios preserved from prior rem values).
      // Kept for icon sizing (text-lg/xl/2xl…) and rare display text; sm…7xl to be audited later.
      xxs: ['0.6rem', { lineHeight: '1.25' }],
      xs: ['0.75rem', { lineHeight: '1.3333' }],
      sm: ['0.875rem', { lineHeight: '1.4286' }],
      base: ['1rem', { lineHeight: '1.375' }],
      lg: ['1.125rem', { lineHeight: '1.3333' }],
      xl: ['1.25rem', { lineHeight: '1.4' }],
      '1.5xl': ['1.375rem', { lineHeight: '1.4545' }],
      '2xl': ['1.5rem', { lineHeight: '1.3333' }],
      '2.5xl': ['1.75rem', { lineHeight: '1.2857' }],
      '3xl': ['1.875rem', { lineHeight: '1.2' }],
      '3.5xl': ['2rem', { lineHeight: '1.25' }],
      '4xl': ['2.25rem', { lineHeight: '1.2222' }],
      '4.5xl': ['2.5rem', { lineHeight: '1.2' }],
      '5xl': ['3rem', { lineHeight: '1.25', fontWeight: '600' }],
      '5.5xl': ['3.5rem', { lineHeight: '1' }],
      '6xl': ['3.75rem', { lineHeight: '1' }],
      '7xl': ['4.5rem', { lineHeight: '1' }],
      '8xl': ['6rem', { lineHeight: '1' }],
      '9xl': ['8rem', { lineHeight: '1' }],
      // Semantic type scale: size×weight matrix. Bare = 400 (with -400 alias), plus -500/-600.
      micro: ['0.75rem', { lineHeight: '1.25', fontWeight: '400' }],
      'micro-400': ['0.75rem', { lineHeight: '1.25', fontWeight: '400' }],
      'micro-500': ['0.75rem', { lineHeight: '1.25', fontWeight: '500' }],
      caption: ['0.875rem', { lineHeight: '1.25', fontWeight: '400' }],
      'caption-400': ['0.875rem', { lineHeight: '1.25', fontWeight: '400' }],
      'caption-500': ['0.875rem', { lineHeight: '1.25', fontWeight: '500' }],
      body: ['1rem', { lineHeight: '1.25', fontWeight: '400' }],
      'body-400': ['1rem', { lineHeight: '1.25', fontWeight: '400' }],
      'body-500': ['1rem', { lineHeight: '1.25', fontWeight: '500' }],
      subhead: ['1.125rem', { lineHeight: '1.22', fontWeight: '400' }],
      'subhead-400': ['1.125rem', { lineHeight: '1.22', fontWeight: '400' }],
      'subhead-500': ['1.125rem', { lineHeight: '1.22', fontWeight: '500' }],
      'subhead-600': ['1.125rem', { lineHeight: '1.22', fontWeight: '600' }],
      title: ['1.25rem', { lineHeight: '1.2', fontWeight: '400' }],
      'title-400': ['1.25rem', { lineHeight: '1.2', fontWeight: '400' }],
      'title-500': ['1.25rem', { lineHeight: '1.2', fontWeight: '500' }],
      heading: ['1.5rem', { lineHeight: '1.17', fontWeight: '400' }],
      'heading-400': ['1.5rem', { lineHeight: '1.17', fontWeight: '400' }],
      'heading-500': ['1.5rem', { lineHeight: '1.17', fontWeight: '500' }],
      'heading-600': ['1.5rem', { lineHeight: '1.17', fontWeight: '600' }],
    },
    fontWeight: {
      thin: '100',
      extralight: '200',
