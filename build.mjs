...
const options = {
    entryPoints: [
        ...
        { out: 'videoDecoderWorker', in: './src/dotnet/UI.Blazor.App/Services/Video/workers/decoder-worker-bootstrap.ts' },
        { out: 'videoProcessingWorker', in: './src/dotnet/UI.Blazor.App/Services/Video/workers/video-processing-worker-bootstrap.ts' },
    ],
    bundle: true,
    platform: 'browser',
    format: 'esm',
