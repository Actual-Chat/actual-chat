...
dotnet publish -f:net10.0-android -c:Release /p:AndroidSigningKeyPass=%ActualChat_AndroidSigningKeyPass% /p:AndroidSigningStorePass=%ActualChat_AndroidSigningStorePass% /p:IsDevMaui=true
popd
